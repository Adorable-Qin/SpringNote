...
The values in the Data Overview come from records and statistics within the current data directory. They represent a summary of application state and do not modify daily, weekly, or monthly notes. Experience progress and the activity heatmap use different statistical scopes.
